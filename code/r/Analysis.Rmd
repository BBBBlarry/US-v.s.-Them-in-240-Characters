...
png("../../figures/Effect of Elite Polarization Measure on PTVI Given Race Competitiveness.png",
    units="in", 
    width=10, 
    height=8, 
    pointsize=12, 
...
png("../../figures/Effect of Elite Polarization Measure on PTVI Given Candidate Incumbency.png",
    units="in", 
    width=10, 
    height=8, 
    pointsize=12, 
...
png("../../figures/Effect of Elite Polarization Measure on PTVI Given Candidate Party.png",
    units="in", 
    width=10, 
    height=8, 
    pointsize=12, 
...
png("../../figures/Effect of Elite Polarization Measure on PTVI Given Candidate Gender.png",
    units="in", 
    width=10, 
    height=8, 
    pointsize=12, 
...
png("../../figures/Effect of Mass Polarization Measure on Given Race Competitiveness",
    units="in", 
    width=10, 
    height=8, 
    pointsize=12, 
...
png("../../figures/Effect of Mass Polarization Measure on PTVI Given Candidate Incumbency",
    units="in", 
    width=10, 
    height=8, 
    pointsize=12, 
...
png("../../figures/Effect of Mass Polarization Measure on PTVI Given Candidate Party",
    units="in", 
    width=10, 
    height=8, 
    pointsize=12, 
...
png("../../figures/Effect of Mass Polarization Measure on PTVI Given Candidate Gender",
    units="in", 
    width=10, 
    height=8, 
    pointsize=12, 
...
## Affects
Disgust: 
- strong positive association with h_dist & s_dist
- slight positive association with ideoConsistVariance
- slight negative associartion with competitiveness0

Anger: 
- strong positive association with h_dist & s_dist

Negative:
- slight positive association with h_dist & s_dist

Fear:
- slight positive association with s_dist

Anticipation: 
- slight negative association with h_dist & s_dist

Positive:
- strong positive association with incumbency1

Surprise:
- slight positive association with incumbency1
...
```{r}
summary(lm(vicousness ~ ideoConsist * incumbency + party + competitiveness, data = relevent_set))
AIC(lm(vicousness ~ ideoConsist * incumbency + party + competitiveness, data = relevent_set), k = 2)
```
