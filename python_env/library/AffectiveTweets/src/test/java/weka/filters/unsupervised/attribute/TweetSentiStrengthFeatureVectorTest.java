 ...
 */
public class TweetSentiStrengthFeatureVectorTest extends AbstractFilterTest {

    public TweetSentiStrengthFeatureVectorTest(String name) {
        super(name);
    }
    ...
    public static Test suite() {
        return new TestSuite(TweetSentiStrengthFeatureVectorTest.class);
    }
